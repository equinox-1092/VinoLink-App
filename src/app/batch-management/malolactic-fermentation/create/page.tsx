...
export default function MalolacticFermentationCreatePage() {
        ...
        <div className="w-full max-w-2xl bg-card rounded-xl shadow-sm border border-border">
          <div className="p-6">
            <h1 className="text-2xl font-semibold text-foreground mb-6">
              {t("batch-management.malolacticFermentation.createTitle")}
            </h1>
              ...
              <div className="space-y-5">
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="malolacticFermentationName"
                  >
                    {t("batch-management.malolacticFermentation.form.name")}
                  </label>
                  <input
                    id="malolacticFermentationName"
                    name="malolacticFermentationName"
                    placeholder={
                      t("batch-management.malolacticFermentation.form.name") ||
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label
                      ...
                      htmlFor="StartDayMLF"
                    >
                      {t("batch-management.malolacticFermentation.form.StartDayMLF")}
                    </label>
                    <input
                      id="StartDayMLF"
                      name="StartDayMLF"
                  ...
                  <div className="space-y-1">
                    <label
                      ...
                      htmlFor="EndDayMLF"
                    >
                      {t("batch-management.malolacticFermentation.form.EndDayMLF")}
                    </label>
                    <input
                      id="EndDayMLF"
                      name="EndDayMLF"
                ...
                <div className="space-y-1">
                  ...
                  >
                    {t("batch-management.malolacticFermentation.form.DurationDays")}
                  </label>
                  <input
                    id="DurationDays"
                    name="DurationDays"
                ...
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="Temperature"
                  >
                    {t("batch-management.malolacticFermentation.form.Temperature")}
                  </label>
                  <input
                    id="Temperature"
                    name="Temperature"
                ...
                <div className="space-y-1">
                  <label
                    className="text-sm font-medium text-muted-foreground"
                    htmlFor="responsibleOperator"
                  >
                    {t("batch-management.malolacticFermentation.form.responsibleOperator")}
                  </label>
                  <input
                    id="responsibleOperator"
                ...
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="notes"
                  >
                    {t("batch-management.malolacticFermentation.form.notes")}
                  </label>
                  <textarea
                    id="notes"
                    name="notes"
