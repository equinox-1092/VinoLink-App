...
export default function AlcoholicFermentationCreatePage() {
        ...
        <div className="w-full max-w-2xl bg-card rounded-xl shadow-sm border border-border">
          <div className="p-6">
            <h1 className="text-2xl font-semibold text-foreground mb-6">
              {t("batch-management.fermentation.createTitle")}
            </h1>
              ...
              <div className="space-y-5">
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="fermentationName"
                  >
                    {t("batch-management.fermentation.form.name")}
                  </label>
                  <input
                    id="fermentationName"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label
                      className="text-sm font-medium text-muted-foreground"
                      htmlFor="dateStartFermentation"
                    >
                      {t("batch-management.fermentation.form.dateStart")}
                    </label>
                    <input
                      id="dateStartFermentation"
                      name="dateStartFermentation"
                      className="w-full px-3 py-2 bg-background border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                      type="date"
                      required
                    />
                  ...
                  <div className="space-y-1">
                    <label
                      ...
                      htmlFor="dateEnd"
                    >
                      {t("batch-management.fermentation.form.dateEnd")}
                    </label>
                    <input
                      id="dateEnd"
                      name="dateEnd"
                ...
                <div className="space-y-1">
                  <label
                    className="text-sm font-medium text-muted-foreground"
                    htmlFor="responsibleOperatorFermentation"
                  >
                    {t(
                      "batch-management.fermentation.form.responsibleOperator"
                    )}
                  </label>
                  <input
                    id="responsibleOperatorFermentation"
                    name="responsibleOperatorFermentation"
                    placeholder={
                      t(
                        "batch-management.fermentation.form.responsibleOperator"
                      ) || "Juan Pérez"
                ...
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="notes"
                  >
                    {t("batch-management.fermentation.form.notes")}
                  </label>
                  <textarea
                    id="notesFermentation"
                    name="notesFermentation"
                    placeholder={
                      t("batch-management.fermentation.form.notes") ||
                      "Observaciones..."
                    }
