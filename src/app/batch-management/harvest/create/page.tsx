        ...
        <div className="w-full max-w-2xl bg-card rounded-xl shadow-sm border border-border">
          <div className="p-6">
            <h1 className="text-2xl font-semibold text-foreground mb-6">
              {t("batch-management.harvest.createTitle")}
            </h1>
              ...
              <div className="space-y-5">
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="harvestName"
                  >
                    {t("batch-management.harvest.form.name")}
                  </label>
                  <input
                    id="harvestName"
                    name="harvestName"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label
                      ...
                      htmlFor="harvestDate"
                    >
                      {t("batch-management.harvest.form.harvestDate")}
                    </label>
                    <input
                      id="harvestDate"
                      name="harvestDate"
                  ...
                  <div className="space-y-1">
                    <label
                      ...
                      htmlFor="pH"
                    >
                      {t("batch-management.harvest.form.pH")}
                    </label>
                    <input
                      id="pH"
                      name="pH"
                ...
                <div className="space-y-1">
                  ...
                  >
                    {t("batch-management.harvest.form.grapeVariety")}
                  </label>
                  <input
                    id="grapeVariety"
                    name="grapeVariety"
                ...
                <div className="space-y-1">
                  ...
                  >
                    {t("batch-management.harvest.form.responsibleOperator")}
                  </label>
                  <input
                ...
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="notes"
                  >
                    {t("batch-management.harvest.form.notes")}
                  </label>
                  <textarea
                    id="notes"
                    name="notes"
