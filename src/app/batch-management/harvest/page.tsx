...
import HarvestTable from "./table/page";
      ...
      <div className="p-6 ">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-semibold">
            {t("batch-management.harvest.title")}
          </h1>
          <button
            onClick={() => router.push("/batch-management/harvest/create")}
          ...
          >
            {t("batch-management.harvest.create")}
          </button>
        </div>
