...
export default function FilteringCreatePage() {
        ...
        <div className="w-full max-w-2xl bg-card rounded-xl shadow-sm border border-border">
          <div className="p-6">
            <h1 className="text-2xl font-semibold text-foreground mb-6">
              {t("batch-management.filtering.createTitle")}
            </h1>
              ...
              <div className="space-y-5">
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="FilteringName"
                  >
                    {t("batch-management.filtering.form.name")}
                  </label>
                  <input
                    id="FilteringName"
                    name="FilteringName"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label
                      className="text-sm font-medium text-muted-foreground"
                      htmlFor="FiltrationDate"
                    >
                      {t("batch-management.filtering.form.FiltrationDate")}
                    </label>
                    <input
                      id="FiltrationDate"
                      name="FiltrationDate"
                  ...
                  <div className="space-y-1">
                    <label
                      ...
                      htmlFor="FilterType"
                    >
                      {t("batch-management.filtering.form.FilterType")}
                    </label>
                    <input
                      id="FilterType"
                      name="FilterType"
                ...
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="PoreSize"
                  >
                    {t("batch-management.filtering.form.PoreSize")}
                  </label>
                  <input
                    id="PoreSize"
                    name="PoreSize"
                    placeholder={
                      t("batch-management.filtering.form.PoreSize") || "10"
                    }
                    className="w-full px-3 py-2 bg-background border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                    type="number"
                    required
                ...
                <div className="space-y-1">
                  <label
                    className="text-sm font-medium text-muted-foreground"
                    htmlFor="FilterPressure"
                  >
                    {t("batch-management.filtering.form.FilterPressure")}
                  </label>
                  <input
                    id="FilterPressure"
                    name="FilterPressure"
                    placeholder={
                      t("batch-management.filtering.form.FilterPressure") || "25"
                    }
                    className="w-full px-3 py-2 bg-background border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                    type="number"
                    required
                ...
                <div className="space-y-1">
                  <label
                    className="text-sm font-medium text-muted-foreground"
                    htmlFor="CloggingAgent"
                  >
                    {t("batch-management.filtering.form.CloggingAgent")}
                  </label>
                  <input
                    id="CloggingAgent"
                    name="CloggingAgent"
                    placeholder={
                      t("batch-management.filtering.form.CloggingAgent") || "25"
                    }
                    className="w-full px-3 py-2 bg-background border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                    type="text"
                    required
                ...
                <div className="space-y-1">
                  <label
                    className="text-sm font-medium text-muted-foreground"
                    htmlFor="StabilizationMethod"
                  >
                    {t("batch-management.filtering.form.StabilizationMethod")}
                  </label>
                  <input
                    id="StabilizationMethod"
                    name="StabilizationMethod"
                    placeholder={
                      t("batch-management.filtering.form.StabilizationMethod") ||
                      "Juan Pérez"
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label
                      className="text-sm font-medium text-muted-foreground"
                      htmlFor="StabilizationTemperature"
                    >
                      {t("batch-management.filtering.form.StabilizationTemperature")}
                    </label>
                    <input
                      id="StabilizationTemperature"
                      name="StabilizationTemperature"
                      placeholder={
                        t("batch-management.filtering.form.StabilizationTemperature") || "25"
                      }
                      className="w-full px-3 py-2 bg-background border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                      type="number"
                      required
                ...
                <div className="space-y-1">
                  <label
                    ...
                    htmlFor="notes"
                  >
                    {t("batch-management.filtering.form.notes")}
                  </label>
                  <textarea
                    id="notes"
                    name="notes"
